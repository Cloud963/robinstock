        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="p-2 rounded-lg hover:bg-neutral-900 transition-colors text-neutral-400 hover:text-robin-neon"
            >
          ...
          {showSettings && (
            <div className="mb-4 p-4 bg-neutral-900 border border-neutral-800 rounded-xl">
              <h3 className="font-semibold mb-3 text-white">Transaction Settings</h3>
              <div>
                <label className="text-sm text-neutral-400">Slippage Tolerance</label>
                <div className="flex gap-2 mt-2">
                  {["0.1", "0.5", "1.0"].map((value) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-sm ${
                        slippage === value
                          ? "bg-robin-neon text-black font-semibold"
                  ...
                  <input
                    ...
                    className="w-20 px-2 py-1 rounded-lg border border-neutral-700 bg-neutral-800 text-white text-sm"
                    placeholder="Custom"
                  />
                </div>
              </div>
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="flex items-center gap-3 p-4 bg-neutral-800 rounded-xl">
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-neutral-700 rounded-lg hover:bg-neutral-600 transition-colors"
                  >
                    <div className="w-6 h-6 bg-robin-neon rounded-full flex items-center justify-center text-black text-xs font-bold">
                      {fromToken.symbol[0]}
                    </div>
                  ...
                  {/* Token Dropdown */}
                  {showFromTokenList && (
                    <div className="absolute top-full left-0 mt-2 w-48 bg-neutral-800 border border-neutral-700 rounded-xl z-10 overflow-hidden">
                      {DEMO_TOKENS.map((token) => (
                        ...
                        >
                          <div className="w-8 h-8 bg-robin-neon rounded-full flex items-center justify-center text-black text-sm font-bold">
                            {token.symbol[0]}
                          </div>
                ...
                <input
                  ...
                  placeholder="0.0"
                  className="flex-1 min-w-0 text-right text-2xl font-semibold bg-transparent outline-none text-white"
                />
              </div>
              <button
                onClick={() => setFromAmount(fromToken.balance)}
                className="text-xs text-robin-neon hover:text-robin-neon/80 mt-1"
              >
                Max
              </button>
            </div>
            ...
            <div className="flex justify-center -my-2 relative z-10">
              <button
                ...
                className="p-3 bg-neutral-800 rounded-xl border-4 border-neutral-900 hover:bg-neutral-700 transition-colors text-robin-neon"
              >
            ...
            {fromAmount && parseFloat(fromAmount) > 0 && (
              <div className="mt-4 p-3 bg-neutral-800 rounded-xl text-sm">
                ...
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-robin-neon">&lt;{priceImpact}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-400">Fee (0.3%)</span>
                  <span className="text-white">${(parseFloat(fromAmount) * fromToken.price * 0.003).toFixed(2)}</span>
                </div>
              </div>
            )}
            ...
            <div className="mt-6">
              {!isConnected ? (
                  ...
                  <ConnectButton.Custom>
                    {({ openConnectModal }) => (
                      <button
                        ...
                        className="w-full py-4 bg-robin-neon text-black rounded-xl font-semibold hover:bg-robin-neon/90 transition-colors"
                      >
                        Connect Wallet
                      </button>
                    )}
                ...
                <button
                  disabled
                  className="w-full py-4 bg-robin-neon text-black rounded-xl font-semibold flex items-center justify-center gap-2"
                >
                  ✓ Swap Successful!
                </button>
              ) : (
                <button
                  ...
                  className="w-full py-4 bg-robin-neon text-black rounded-xl font-semibold hover:bg-robin-neon/90 transition-colors disabled:bg-neutral-700 disabled:text-neutral-500 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSwapping ? (
                    <>
          ...
          <div className="mt-6 p-4 bg-neutral-900 border border-neutral-800 rounded-xl">
            <h3 className="font-semibold text-robin-neon mb-2">💡 Demo Mode</h3>
